...
Write-Host "  3) Packages 页面 ★只传 dist\$bundleName★ 这一个文件"
Write-Host "     —— 不要顺手把 cmdpal\PowerTranslatorExtension\bin\... 下的 .msix 一起拖上去，"
Write-Host "        那些是 bundle 的零件，和 bundle 同时上传会让 Partner Center 卡在'处理中'状态。"
Write-Host "  4) 'Device family availability' 勾上 Windows 10/11 Desktop（其余不勾）"
Write-Host "  5) 填 listing / pricing / capability justification → Submit"
